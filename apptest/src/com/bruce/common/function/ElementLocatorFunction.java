...
import com.bruce.configuration.AndroidDriverWait;

/**
 * 页面元素获取定位基类，供给Page层使用
 */


public class ElementLocatorFunction implements ElementLocatorInterface {
	AndroidDriver<AndroidElement> driver = null;
	
	public ElementLocatorFunction(AndroidDriver<AndroidElement> androidDriver) {
